                    ...
                    <div className="chat-empty">
                        <div className="chat-empty-content">
                            ...
                            >
                             ...
                             <h2 style={{ minHeight: '60px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <Typewriter text={activeSpace ? activeSpace.name : 'Начните диалог'} delay={2000} speed={70} />
                            </h2>
                            <p style={{ minHeight: '100px', color: 'rgba(255,255,255,0.6)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', maxWidth: '400px', margin: '0 auto' }}>
